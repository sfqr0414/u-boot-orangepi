...
write_prefix() {
    ...
    # compressed with gzip to reduce the size of this script
    base64 -d <<'EOF' | gunzip -c > "$out"
H4sIAK6WZmUC/1VY2w6CQBD9Z/ppQXjQqmhDRhQSiLNyKGsIFUqj3YmP/eF1hjW7v2nD0lC3Pwes/5
u2b9j97+Yfg+fwLwfy+LxxfH4fj8LwcP77/uNeXnlxcAQAAP//P8NnLc0UAAAA
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD8IhI+C+qxzQBQAAA==
EOF
}
